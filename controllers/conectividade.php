...
class Conectividade extends Controller {
    ...
    function __construct() {
        ...
        if (!isset($_SESSION['LOGIN'])) {
            ...
            $conectividade_model = new Sessao_Model();

            // Consulta as credenciais de login
            $existe = $conectividade_model->Pesquisa_Credenciais($login_informado); // Executa a query no BD e armazena o resultado numa array
