...
class Conta extends Controller {
    ...
    function __construct() {
        ...
        if (!isset($_SESSION['LOGIN'])) {
            ...
            // Força um logout caso o LOGIN/SENHA estejam em branco
            ...
            $conta_model = new Sessao_Model();

            // Consulta as credenciais de login
            $existe = $conta_model->Pesquisa_Credenciais($login_informado); // Executa a query no BD e armazena o resultado numa array
            ...
            if ($existe[0] == '0') {
                ...
                $dados = $conta_model->Dados_Cliente($login_informado); // Executa a query no BD e armazena o resultado numa array
                ...
                $this->view->renderJQ('conta/index');
            }
        }
    }
}
