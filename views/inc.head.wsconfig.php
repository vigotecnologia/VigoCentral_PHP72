...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt-br" lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $funcoes->baseProjeto(); ?>/public/css/awesomeicons.css" />
        <link rel="stylesheet" type="text/css" href="<?php echo $funcoes->baseProjeto(); ?>/public/richtext/style.richtext.css" />
        ...
        <script type="text/javascript" src="<?php echo $funcoes->baseProjeto(); ?>/public/richtext/jquery.richtext.js"></script>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                $('#lnkAceite').click(function () {
                    var styleToRemove = {display: "none"};
                    var styleToAdd = {display: "block"};
                    var position = {position: "absolute", display: "block"};

                    $(".boxWSConfig").fadeOut('fast');
                    $('#alterarAceite').css(styleToRemove);
                    $('#alterarAceite').fadeIn('slow');
                    $('#alterarAceite').css(position);
                    $('#boxAceite').animate({height: 'swing'});
                    $('#boxAceite').fadeIn('slow').css(styleToAdd);
                });
