                    ...
                    <form name="formTema" action="wsconfig" method="post">
                        <label for="txtTema" class="optTema" title="<?php echo $this->central_tema_descricao; ?>">
                            ...
                            <select name="txtTema" id="txtTema" required="required" autofocus>
                                ...
                                <option <?php if ($this->central_tema_valor == 'amarelo') { echo 'selected'; } ?> value="amarelo">Estilo Amarelo</option>
                                <option <?php if ($this->central_tema_valor == 'azul') { echo 'selected'; } ?> value="azul">Estilo Azul</option>
                                <option <?php if ($this->central_tema_valor == 'cinza') { echo 'selected'; } ?> value="cinza">Estilo Cinza</option>
                                <option <?php if ($this->central_tema_valor == 'laranja') { echo 'selected'; } ?> value="laranja">Estilo Laranja</option>
                                <option <?php if ($this->central_tema_valor == 'magenta') { echo 'selected'; } ?> value="magenta">Estilo Magenta</option>
                                <option <?php if ($this->central_tema_valor == 'rosa') { echo 'selected'; } ?> value="rosa">Estilo Rosa</option>
                                <option <?php if ($this->central_tema_valor == 'roxo') { echo 'selected'; } ?> value="roxo">Estilo Roxo</option>
                                <option <?php if ($this->central_tema_valor == 'turquesa') { echo 'selected'; } ?> value="turquesa">Estilo Turquesa</option>
                                <option <?php if ($this->central_tema_valor == 'verde') { echo 'selected'; } ?> value="verde">Estilo Verde</option>
                                <option <?php if ($this->central_tema_valor == 'vermelho') { echo 'selected'; } ?> value="vermelho">Estilo Vermelho</option>
                            </select>
                        </label>
                    ...
                    <form name="formGrafico" action="wsconfig" method="post">
                        <label for="txtGrafico" class="optTema" title="<?php echo $this->central_grafico_descricao; ?>">
                            ...
                            <select name="txtGrafico" id="txtGrafico" required="required" autofocus>
                                ...
                                <option value="" disabled="disabled">&nbsp;</option>
                                <option <?php if ($this->central_grafico_valor == 'area') { echo 'selected'; } ?> value="area">Gr&aacute;fico em &Aacute;rea</option>
                                <option <?php if ($this->central_grafico_valor == 'column') { echo 'selected'; } ?> value="column">Gr&aacute;fico em Colunas</option>
                                <option <?php if ($this->central_grafico_valor == 'spline') { echo 'selected'; } ?> value="spline">Gr&aacute;fico em Curvas</option>
                                <option <?php if ($this->central_grafico_valor == 'line') { echo 'selected'; } ?> value="line">Gr&aacute;fico em Linhas</option>
                            </select>
                        </label>
                ...
                <div class="formWSConfig">
                    <form name="formPermissoes" action="wsconfig" method="post">
                        <label class="optTema optColunas lblPermissoes" title="<?php echo $this->modulo_faturas_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtFaturas" <?php if ($this->modulo_faturas_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes optRight" title="<?php echo $this->modulo_contratos_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtContrato" <?php if ($this->modulo_contratos_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes" title="<?php echo $this->modulo_notafiscal_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtNotasFiscais" <?php if ($this->modulo_notafiscal_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes optRight" title="<?php echo $this->modulo_atendimentos_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtAtendimento" <?php if ($this->modulo_atendimentos_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes" title="<?php echo $this->modulo_servicos_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtServicos" <?php if ($this->modulo_servicos_permissao == 'S') { echo 'checked="checked"'; } ?>v /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes optRight" title="<?php echo $this->modulo_abrir_atendimento_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtAbrirAtendimento" <?php if ($this->modulo_abrir_atendimento_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes" title="<?php echo $this->modulo_acessos_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtAcessos" <?php if ($this->modulo_acessos_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes optRight" title="<?php echo $this->modulo_senha_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtSenhaCentral" <?php if ($this->modulo_senha_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes" title="<?php echo $this->modulo_graficos_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtGraficos" <?php if ($this->modulo_graficos_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                        ...
                        <label class="optTema optColunas lblPermissoes optRight" title="<?php echo $this->modulo_mksenha_descricao; ?>">
                            <span>
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="checkbox" name="txtMkSenha" <?php if ($this->modulo_mksenha_permissao == 'S') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                    ...
                    <form name="formContrato" action="wsconfig" method="post" enctype="multipart/form-data" >
                        <label class="optTema optColunas lblHint" title="<?php echo $this->central_contrato_descricao; ?>">
                            ...
                            <div class="lblContrato">
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="radio" id="arquivoCustom" name="txtTipoArquivo" value="1" <?php if ($this->central_contrato_valor == 'custom') { echo 'checked="checked"'; } ?> /></span>
                                </div>
                                <div class="blocoRotulo">Personalizado</div>
                            </div>
                            <div class="lblContrato lblExtra">
                                <div class="blocoRotuloChk">
                                    <span class="lblRadio"><input class="txtRadio" type="radio" id="arquivoDefault" name="txtTipoArquivo" value="0" <?php if ($this->central_contrato_valor == 'default') { echo 'checked="checked"'; } ?> /></span>
                                </div>
